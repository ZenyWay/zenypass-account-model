# Contributing to zenypass-account-model
...
[zenypass-account-model Gitter channel](https://gitter.im/ZenyWay/zenypass-account-model).

## <a name="issues"></a> Issues
### Security issues
For the security of the community relying on zenypass-account-model,
...
are tracked as GitHub [issues in this repository](https://github.com/ZenyWay/zenypass-account-model/issues):
* please either [submit a new issue](https://github.com/ZenyWay/zenypass-account-model/issues/new)
...
**zenypass-account-model version:** (only for issues) first version of zenypass-account-model affected by the issue
...
* a PR must close at least one [open issue](https://github.com/ZenyWay/zenypass-account-modelg/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen).
The corresponding issues should be listed in the title of the PR,
e.g. "close #21, #42".
* all PRs must pass the full zenypass-account-model test suite and
...
https://github.com/ZenyWay/zenypass-account-model/blob/master/ICLA.
```
This is required both in the contributor's own interest,
and that of the community relying on this project,
...
#### CI
CI testing runs on [TravisCI](https://travis-ci.org/ZenyWay/zenypass-account-model).
